...
public class StructureSelection implements ActionListener {
    ...
    public StructureSelection() {
        f = new JFrame("Data Structures Visualization");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == bArray) {
            Visualizer.Array.DisplayArray.main(null);
            f.setVisible(false);
        } else if (ae.getSource() == bLinked) {
            Visualizer.LinkedList.DisplayLinked.main(null);
            f.setVisible(false);
            ...
            if (Objects.equals(choice, "1")) {
                Visualizer.Stack.arrayStack.main(null);
                f.setVisible(false);
            } else if (Objects.equals(choice, "2")) {
                Visualizer.Stack.linkedStack.main(null);
                f.setVisible(false);
            }
            System.out.println(choice);
            ...
            if (Objects.equals(choice, "1")) {
                Visualizer.Queue.DisplayArrayQueue.main(null); //will send the name of the user
                f.setVisible(false);
            } else if (Objects.equals(choice, "2")) {
                Visualizer.Queue.DisplayLinkedQueue.main(null);
                f.setVisible(false);
            }
            System.out.println(choice);
        }
