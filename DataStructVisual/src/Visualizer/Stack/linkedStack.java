...
import LINKED_STACK.LinkedStack;
...
public class linkedStack {
    ...
    public static void main(String[] args) {
        ...
        linkedStack.Graphic graphic = new linkedStack.Graphic();
        ...
        spRemove.setBounds(300, 130, 220, 200);
        ...
        b1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                graphic.addRectangle(0, Graphic.num, 50, 39, t1.getText());
